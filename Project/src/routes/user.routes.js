...
router.route("/refresh-token").post(verifyJWT,refreshTokenHandler);
...
router.route("/update-avatar").patch(verifyJWT,upload.single("avatar"),updateCurrentUserAvatar);
router.route("/update-cover").patch(verifyJWT,upload.single("coverImage"),updateCurrentUserCoverImage);
router.route("/c/:username").get(getUserProfileByUsername);
